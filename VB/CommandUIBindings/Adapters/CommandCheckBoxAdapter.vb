...
Imports SilverlightApplication102.CommandUIBindings.UIState
...
Namespace SilverlightApplication102.CommandUIBindings.Adapters
	...
	Public Class CommandCheckBoxAdapter
		...
		Private Sub OnEditValueChanged(ByVal sender As Object, ByVal e As DevExpress.AgEditors.EditValueChangedEventArgs)
			UnsubscribeCheckBoxEvents()
			Try
				Dim command As Command = CreateCommand()
				If command IsNot Nothing Then
